...
<section class="py-15 md:py-12 bg-gray-100">
    <div class="mx-auto px-12 md:px-4 lg:px-6 text-center">
        <h3 class="text-customBlack text-[2rem] font-[800] pb-6">Innovation Platform</h3>
        <p class="text-[1rem] font-[400] mb-6 md:mb-8 max-w-lg md:max-w-4xl lg:max-w-5xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 max-w-xl sm:max-w-2xl md:max-w-5xl mx-[1.6rem] sm:mx-[5rem] md:mx-auto">
